...
namespace Editor.Forms
{
    public partial class LevelEditor : Form
    {
        ...
        private void btnApplyMapInfo_Click(object sender, EventArgs e)
        {
            ...
            pnlTileset.SetTiles(map.Tileset, 8);
            pnlMap.SetMap(map);
            mCursor =null;
        }
        ...
        {
            var map = FileDialog.ShowLoad<Map>(PathType.Maps);
            if (map != null)
            {
                pnlTileset.SetTiles(map.Tileset,8);
                pnlMap.SetMap(map);
        ...
        {             
            ...
            {     
                ...
                if (!pnlTileset.Tileset.GetTiles().Any(p => p.TileID == selectedMapTile.TileID))
                {
                    ...
                    pnlTileset.SetTiles(pnlTileset.Tileset, 8);
                }
        ...
        private void lstGroups_ItemCheck(object sender, ItemCheckEventArgs e)
        {
            ...
            {              
                if(lstGroups.GetItemChecked(0,e))                
                    pnlTileset.SetTiles(pnlMap.Tileset, 8);
            ...
            pnlTileset.SetTiles(filteredTilset, 8);
        }
